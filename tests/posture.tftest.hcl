...
mock_provider "aws" {
  mock_data "aws_secretsmanager_secret_version" {
    defaults = {
      secret_string = "{\"nextcloud_admin_user\": \"e2e-test-nextcloud_admin_user\", \"nextcloud_admin_user_password\": \"e2e-test-nextcloud_admin_user_password\", \"nextcloud_password\": \"e2e-test-nextcloud_password\", \"nextcloud_username\": \"e2e-test-nextcloud_username\"}"
    }
  }
